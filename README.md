...
Load the [source/_posts] folder and use the [new file] icon above its listing.  [[show]][new-file]

Github will automatically create a "[fork]" (a copy) of this project for your new file.
